...
$expected = ['nome', 'numero_quarto', 'telefone', 'nacionalidade','email','conhecimento','motivo','Atendimento_no_momento_da_Reserva','Atendimento_ao_balcão','Funcionarios','Check-In','Check-Out','Segurança',
'Comforto_e_Limpeza_dos_Quartos','Pequeno-Almoço','Envolvente_externo_ao_empreendimento','Internet','Acessibilidade_ao_empreendimento','Acessibilidade_a_Ilha','Classificação_geral','mensagem'];
$required = ['nome', 'numero_quarto', 'telefone', 'nacionalidade','email','conhecimento','motivo'];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'villamorgana@gmail.com'  =>
            ['#subject#' => 'Avaliação Hote<link rel="icon" href="img/fav.ico">']
   ];
    ...
    try {
        ...
        $message = Swift_Message::newInstance()
           ...
           ->setFrom($email);
            ...
            $image_logo = $message->embed(Swift_Image::fromPath('img/logos.png'));
...
<title>Hote<link rel="icon" href="img/fav.ico"> </title>
</head>
...
center">Avaliação - Hote<link rel="icon" href="img/fav.ico"></h1>
</td>
</tr>
<tr>
<td style="padding-left:5em;padding-right:5em;">
<p>Hote<link rel="icon" href="img/fav.ico">: Calheta de São Miguel, Achada Batalha Calheta, 7215, Santiago, CABO VERDE</p>
<p><b>Movel 1:</b> (+238) 996 93 56</p>
<p><b>Movel 2:</b> (+238) 995 90 83</p>
<p><b>Movel 3:</b> (+238) 912 60 20</p>
</td>
</tr>
<tr>
<td style="text-align:center; padding:2em;">
<img src="$image_local" style="width:200px; height:100px;">
<img src="$image_hotel" style="width:200px; height:125px;">
</td>
</tr>
<tr>
<td style="padding-top: 0.5em">
<h3 style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, sans-serif; color: #0E618C;padding-left:4.3em;padding-right:5em;">Detalhes da Apreciação</h3>
EOT;
